...
mixin _$FeedStore on _FeedStoreBase, Store {
  late final _$valueAtom = Atom(name: '_FeedStoreBase.value', context: context);
  ...
  late final _$_FeedStoreBaseActionController = ActionController(
    name: '_FeedStoreBase',
    context: context,
  );
